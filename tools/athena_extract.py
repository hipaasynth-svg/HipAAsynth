...
WANTED_IDS = {
    5083, 9201, 9202, 9203, 132797, 201826, 255573, 313217, 316139, 316866,
    317009, 317576, 321052, 381591, 432867, 439777, 440383, 442588, 3000905,
    3000963, 3004501, 3011960, 3016407, 3016723, 3019550, 3023103, 3028288,
    3049187, 4212540, 4329847, 42529224, 46271022,
}
...
WANTED_CODES = {
    ...
    ("RxNorm", "1091652"), ("RxNorm", "1191"), ("RxNorm", "1439816"),
    ("RxNorm", "1819"), ("RxNorm", "1922512"), ("RxNorm", "2358846"),
    ("RxNorm", "2472695"), ("RxNorm", "3407"), ("RxNorm", "5470"),
